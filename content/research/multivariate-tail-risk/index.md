...
links:
    - name: SSRN
      url: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6627819
cover:
    image: "Scenario_SPF_GDP_screenshot.png"
    alt: "Scenario-based SPF GDP density forecasts"
    caption: "Scenario Density for GDP Growth"
    relative: true
---
...
<p style="text-align:center;"><strong>Scenario Density for GDP Growth</strong></p>

![Scenario-based SPF GDP density forecasts](Scenario_SPF_GDP_screenshot.png)